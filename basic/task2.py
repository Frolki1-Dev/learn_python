...
for price in prices:
    if price <= 20:
        new_prices.append(price / 100 * 80)
    elif price > 20 and price <= 50:
        new_prices.append(price / 100 * 60)
    else:
        new_prices.append(price / 100 * 40)
...
for c in chaos:
    if "old" in c:
        c = int(c.split(": ").pop())
        if c <= 20:
            order.append(c / 100 * 80)
        elif c > 20 and price <= 50:
            order.append(c / 100 * 60)
        else:
            order.append(c / 100 * 40)
    else:
        c = int(c.split(": ").pop())
        order.append(c)
